...
### coordinode-auth
## [0.4.4](https://github.com/structured-world/coordinode/compare/coordinode-auth-v0.4.3...coordinode-auth-v0.4.4) - 2026-06-07
...
### coordinode-bench
## [0.4.4](https://github.com/structured-world/coordinode/compare/coordinode-bench-v0.4.3...coordinode-bench-v0.4.4) - 2026-06-07
...
## [0.4.4](https://github.com/structured-world/coordinode/compare/coordinode-bench-vector-ann-v0.4.3...coordinode-bench-vector-ann-v0.4.4) - 2026-06-07

#### Added

- *(bench)* high-D dataset prep covering 1536 to 8192
- *(bench)* HDF5 to fvecs converter for high-D datasets
- *(bench)* --search-mode flag for exact (recall=1.0) baseline
- *(bench)* add chromadb competitor adapter + denser ef sweep
...
- *(bench)* --rabitq-bits flag for Extended-RaBitQ sweep
- *(bench)* HNSW M sweep (16, 24, 32) + UI filter
...
- *(bench)* drop high-D ritual section from vector-ann README
- *(bench)* high-D tier provisioning + workflow trigger guide

#### Fixed

- *(bench)* collect MT search handles before joining
- *(vector)* apply-phase backfill keeps closer candidates over incumbents
- *(bench-vector-ann)* chunk insert_batch at 1k not 10k (recall regression)

#### Performance

- *(bench)* chunked workers replace par_iter for MT search
- *(bench)* widen ef_search sweep to match ann-benchmarks defaults
- *(bench-vector-ann)* chunked insert_batch instead of per-row insert
...
- *(vector)* real search-MT via --search-threads N (E_core unblocker)
- *(vector)* 100k subset by default + ST+MT4 sweep per push

#### Revert

- *(bench-vector-ann)* per-row insert until insert_batch recall bug is fixed

### coordinode-client
## [0.4.4](https://github.com/structured-world/coordinode/compare/coordinode-client-v0.4.3...coordinode-client-v0.4.4) - 2026-06-07
...
### coordinode-cluster
## [0.4.4](https://github.com/structured-world/coordinode/compare/coordinode-cluster-v0.4.3...coordinode-cluster-v0.4.4) - 2026-06-07
...
### coordinode-core
## [0.4.4](https://github.com/structured-world/coordinode/compare/coordinode-core-v0.4.3...coordinode-core-v0.4.4) - 2026-06-07
...
### coordinode-embed
## [0.4.4](https://github.com/structured-world/coordinode/compare/coordinode-embed-v0.4.3...coordinode-embed-v0.4.4) - 2026-06-07
...
## [0.4.4](https://github.com/structured-world/coordinode/compare/coordinode-gold-bench-v0.4.3...coordinode-gold-bench-v0.4.4) - 2026-06-07
...
## [0.4.4](https://github.com/structured-world/coordinode/compare/coordinode-integration-v0.4.3...coordinode-integration-v0.4.4) - 2026-06-07
...
### coordinode-modality
## [0.4.4](https://github.com/structured-world/coordinode/compare/coordinode-modality-v0.4.3...coordinode-modality-v0.4.4) - 2026-06-07
...
### coordinode-query
## [0.4.4](https://github.com/structured-world/coordinode/compare/coordinode-query-v0.4.3...coordinode-query-v0.4.4) - 2026-06-07
...
### coordinode-raft
## [0.4.4](https://github.com/structured-world/coordinode/compare/coordinode-raft-v0.4.3...coordinode-raft-v0.4.4) - 2026-06-07
...
### coordinode-s3
## [0.4.4](https://github.com/structured-world/coordinode/compare/coordinode-s3-v0.4.3...coordinode-s3-v0.4.4) - 2026-06-07
...
### coordinode-search
## [0.4.4](https://github.com/structured-world/coordinode/compare/coordinode-search-v0.4.3...coordinode-search-v0.4.4) - 2026-06-07
...
### coordinode-server
## [0.4.4](https://github.com/structured-world/coordinode/compare/v0.4.3...v0.4.4) - 2026-06-07
...
### coordinode-storage
## [0.4.4](https://github.com/structured-world/coordinode/compare/coordinode-storage-v0.4.3...coordinode-storage-v0.4.4) - 2026-06-07
...
## [0.4.4](https://github.com/structured-world/coordinode/compare/coordinode-test-fixtures-v0.4.3...coordinode-test-fixtures-v0.4.4) - 2026-06-07
...
## [0.4.4](https://github.com/structured-world/coordinode/compare/coordinode-timeseries-v0.4.3...coordinode-timeseries-v0.4.4) - 2026-06-07
...
### coordinode-vector
## [0.4.4](https://github.com/structured-world/coordinode/compare/coordinode-vector-v0.4.3...coordinode-vector-v0.4.4) - 2026-06-07
